...
const Ki = ({ className: e }) => (e || (e = "border-grey-200 dark:border-grey-800"), /* @__PURE__ */ d.jsx(Bl, { asChild: !0, decorative: !0, children: /* @__PURE__ */ d.jsx("hr", { className: e }) })), es = A("text-xs font-semibold tracking-normal"), ts = A(
  ...
  ReactComponent: wM,
  default: xM
}, Symbol.toStringTag, { value: "Module" })), AM = /* @__PURE__ */ Object.assign({ "../assets/icons/add.svg": $l, "../assets/icons/ai-tagging-spark.svg": eu, "../assets/icons/align-center.svg": ru, "../assets/icons/align-left.svg": su, "../assets/icons/angle-brackets.svg": lu, "../assets/icons/arrow-bottom-left.svg": gu, "../assets/icons/arrow-bottom-right.svg": mu, "../assets/icons/arrow-down.svg": pu, "../assets/icons/arrow-left.svg": fu, "../assets/icons/arrow-right.svg": Du, "../assets/icons/arrow-top-left.svg": Su, "../assets/icons/arrow-top-right.svg": Cu, "../assets/icons/arrow-up.svg": zu, "../assets/icons/at-sign.svg": Pu, "../assets/icons/baseline-chart.svg": Uu, "../assets/icons/bell.svg": Hu, "../assets/icons/bills.svg": Bu, "../assets/icons/book-open.svg": Vu, "../assets/icons/brackets.svg": $u, "../assets/icons/card-list.svg": e0, "../assets/icons/cardview.svg": r0, "../assets/icons/check-circle.svg": s0, "../assets/icons/check.svg": l0, "../assets/icons/chevron-down.svg": g0, "../assets/icons/chevron-left.svg": m0, "../assets/icons/chevron-right.svg": p0, "../assets/icons/chevron-up.svg": f0, "../assets/icons/close.svg": D0, "../assets/icons/column-layout.svg": S0, "../assets/icons/comment-fill.svg": C0, "../assets/icons/comment.svg": z0, "../assets/icons/crown.svg": P0, "../assets/icons/discount.svg": U0, "../assets/icons/dotdotdot.svg": H0, "../assets/icons/download.svg": B0, "../assets/icons/duplicate.svg": V0, "../assets/icons/ellipsis.svg": $0, "../assets/icons/email-check.svg": ed, "../assets/icons/email.svg": rd, "../assets/icons/emailfield.svg": sd, "../assets/icons/error-fill.svg": ld, "../assets/icons/export.svg": gd, "../assets/icons/eyedropper.svg": md, "../assets/icons/facebook.svg": pd, "../assets/icons/finger-up.svg": fd, "../assets/icons/hamburger.svg": Dd, "../assets/icons/heart-fill.svg": Sd, "../assets/icons/heart.svg": Cd, "../assets/icons/home.svg": zd, "../assets/icons/hyperlink-circle.svg": Pd, "../assets/icons/import.svg": Ud, "../assets/icons/info-fill.svg": Hd, "../assets/icons/integration.svg": Bd, "../assets/icons/key.svg": Vd, "../assets/icons/labs-flask.svg": $d, "../assets/icons/language.svg": e1, "../assets/icons/laptop.svg": r1, "../assets/icons/layer.svg": s1, "../assets/icons/layout-headline.svg": l1, "../assets/icons/layout-module-1.svg": g1, "../assets/icons/like.svg": m1, "../assets/icons/link-broken.svg": p1, "../assets/icons/linkedin.svg": f1, "../assets/icons/listview.svg": D1, "../assets/icons/lock-locked.svg": S1, "../assets/icons/lock-unlocked.svg": C1, "../assets/icons/magnifying-glass.svg": z1, "../assets/icons/mail-block.svg": P1, "../assets/icons/megaphone.svg": U1, "../assets/icons/mobile.svg": H1, "../assets/icons/modules-3.svg": B1, "../assets/icons/money-bags.svg": V1, "../assets/icons/navigation.svg": $1, "../assets/icons/palette.svg": eg, "../assets/icons/pen.svg": rg, "../assets/icons/picture.svg": sg, "../assets/icons/piggybank.svg": lg, "../assets/icons/play-fill.svg": gg, "../assets/icons/portal.svg": mg, "../assets/icons/question-circle.svg": pg, "../assets/icons/recepients.svg": fg, "../assets/icons/reload.svg": Dg, "../assets/icons/share.svg": Sg, "../assets/icons/single-user-block.svg": Cg, "../assets/icons/single-user-fill.svg": Vl, "../assets/icons/success-fill.svg": zg, "../assets/icons/tags-block.svg": Pg, "../assets/icons/tags-check.svg": Ug, "../assets/icons/textfield.svg": Hg, "../assets/icons/thumbs-down.svg": Bg, "../assets/icons/thumbs-up.svg": Vg, "../assets/icons/time-back.svg": $g, "../assets/icons/trash.svg": eM, "../assets/icons/twitter-x.svg": rM, "../assets/icons/unsplash-logo.svg": sM, "../assets/icons/upload.svg": lM, "../assets/icons/user-add.svg": gM, "../assets/icons/user-fill.svg": mM, "../assets/icons/user-page.svg": pM, "../assets/icons/user.svg": fM, "../assets/icons/warning.svg": DM, "../assets/icons/world-clock.svg": SM }), Be = ({ name: e, size: t = "md", colorClass: n = "", className: r = "" }) => {
  const { ReactComponent: o } = AM[`../assets/icons/${e}.svg`];
  let i = "", s = {};
...
}, LM = ({ size: e, color: t, delay: n, style: r }) => {
  ...
  const w = /* @__PURE__ */ d.jsxs(d.Fragment, { children: [
    ...
    N && /* @__PURE__ */ d.jsxs("div", { className: "absolute flex", children: [
      /* @__PURE__ */ d.jsx(LM, { color: p, size: t }),
...
var V = globalThis && globalThis.__assign || function() {
  ...
  return n;
}, Jn = Symbol("NiceModalId"), Rr = {}, mt = P.createContext(Rr), os = P.createContext(null), Ie = {}, Dt = {}, CM = 0, jt = function() {
  throw new Error("No dispatch method detected, did you embed your app with NiceModal.Provider?");
}, is = function() {
  return "_nice_modal_" + CM++;
}, ss = function(e, t) {
  var n, r, o;
...
function Hr(e, t) {
  var n = Nn(e);
  if (typeof e != "string" && !Ie[n] && pn(n, e), jt(kM(n, t)), !be[n]) {
...
var as = function(e) {
  var t = Nn(e);
  jt(ZM(t)), delete be[t], delete st[t];
}, PM = function(e, t) {
  jt(zM(e, t));
};
function cs(e, t) {
...
var WM = function(e) {
  ...
  return !n || !r ? P.createElement(UM, null, t) : (jt = n, P.createElement(
    mt.Provider,
    { value: r },
    t,
    P.createElement(ls, null)
...
let JM = { data: "" }, VM = (e) => typeof window == "object" ? ((e ? e.querySelector("#_goober") : window._goober) || Object.assign((e || document.head).appendChild(document.createElement("style")), { innerHTML: " ", id: "_goober" })).firstChild : e || JM, XM = /(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g, FM = /\/\*[^]*?\*\/|  +/g, Eo = /\n+/g, ke = (e, t) => {
  let n = "", r = "", o = "";
  for (let i in e) {
    let s = e[i];
...
function yn(e) {
  ...
  return $M(n.unshift ? n.raw ? qM(n, [].slice.call(arguments, 1), t.p) : n.reduce((r, o) => Object.assign(r, o && o.call ? o(t.p) : o), {}) : n, VM(t.target), t.g, t.o, t.k);
}
let gs, cr, lr;
yn.bind({ g: 1 });
let De = yn.bind({ k: 1 });
...
function Re(e, t) {
  ...
  return function() {
    ...
    function o(i, s) {
      ...
      n.p = Object.assign({ theme: cr && cr() }, a), n.o = / *go\d+/.test(l), a.className = yn.apply(n, r) + (l ? " " + l : ""), t && (a.ref = s);
      let u = e;
...
var eI = (e) => typeof e == "function", tn = (e, t) => eI(e) ? e(t) : e, tI = (() => {
  let e = 0;
  return () => (++e).toString();
})(), Ms = (() => {
  let e;
...
})(), nI = 20, Vt = /* @__PURE__ */ new Map(), rI = 1e3, Zo = (e) => {
  if (Vt.has(e))
    return;
  let t = setTimeout(() => {
  ...
  switch (t.type) {
    case 0:
      return { ...e, toasts: [t.toast, ...e.toasts].slice(0, nI) };
    case 1:
      return t.toast.id && oI(t.toast.id), { ...e, toasts: e.toasts.map((i) => i.id === t.toast.id ? { ...i, ...t.toast } : i) };
    case 2:
      let { toast: n } = t;
...
}, iI = { blank: 4e3, error: 4e3, success: 2e3, loading: 1 / 0, custom: 4e3 }, sI = (e = {}) => {
  let [t, n] = Z(Ft);
  L(() => (Xt.push(n), () => {
    let o = Xt.indexOf(n);
    o > -1 && Xt.splice(o, 1);
  ...
  return { ...t, toasts: r };
}, aI = (e, t = "blank", n) => ({ createdAt: Date.now(), visible: !0, type: t, ariaProps: { role: "status", "aria-live": "polite" }, message: e, pauseDuration: 0, ...n, id: (n == null ? void 0 : n.id) || tI() }), At = (e) => (t, n) => {
  let r = aI(t, e, n);
...
var cI = (e, t) => {
  ...
  return { toasts: t, handlers: { updateHeight: cI, startPause: lI, endPause: r, calculateOffset: o } };
}, dI = De`
from {
...
`, DI = ({ toast: e }) => {
  ...
  return t !== void 0 ? typeof t == "string" ? c(vI, null, t) : t : n === "blank" ? null : c(fI, null, c(jI, { ...r }), n !== "loading" && c(hI, null, n === "error" ? c(II, { ...r }) : c(yI, { ...r })));
}, wI = (e) => `
...
`, SI = "0%{opacity:0;} 100%{opacity:1;}", AI = "0%{opacity:1;} 100%{opacity:0;}", LI = Re("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`, TI = (e, t) => {
  let n = e.includes("top") ? 1 : -1, [r, o] = Ms() ? [SI, AI] : [wI(n), xI(n)];
  return { animation: t ? `${De(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards` : `${De(o)} 0.4s forwards cubic-bezier(.06,.71,.55,1)` };
}, kI = Gi(({ toast: e, position: t, style: n, children: r }) => {
  let o = e.height ? TI(e.position || t || "top-center", e.visible) : { opacity: 0 }, i = c(DI, { toast: e }), s = c(CI, { ...e.ariaProps }, tn(e.message, e));
  return c(LI, { className: e.className, style: { ...o, ...n, ...e.style } }, typeof r == "function" ? r({ icon: i, message: s }) : c(mn, null, i, s));
});
KM(c);
var zI = ({ id: e, className: t, style: n, onHeightUpdate: r, children: o }) => {
  let i = T((s) => {
    if (s) {
      let a = () => {
...
`, Zt = 16, PI = ({ reverseOrder: e, position: t = "top-center", toastOptions: n, gutter: r, children: o, containerStyle: i, containerClassName: s }) => {
  let { toasts: a, handlers: l } = uI(n);
  return c("div", { style: { position: "fixed", zIndex: 9999, top: Zt, left: Zt, right: Zt, bottom: Zt, pointerEvents: "none", ...i }, className: s, onMouseEnter: l.startPause, onMouseLeave: l.endPause }, a.map((u) => {
    let g = u.position || t, M = l.calculateOffset(u, { reverseOrder: e, gutter: r, defaultPosition: t }), m = EI(g, M);
    return c(zI, { id: u.id, key: u.id, onHeightUpdate: l.updateHeight, className: u.visible ? ZI : "", style: m }, u.type === "custom" ? tn(u.message, u) : o ? o(u) : c(kI, { toast: u, position: g }));
  }));
};
const Is = P.createContext({ isDirty: !1, setGlobalDirtyState: () => {
  ...
  darkMode: !1
}), UI = ({ fetchKoenigLexical: e, darkMode: t, children: n }) => {
  const [r, o] = Z(!1), i = (s) => {
    o(s);
  };
  return /* @__PURE__ */ d.jsx(OI.Provider, { value: { isAnyTextFieldFocused: r, setFocusState: i, fetchKoenigLexical: e, darkMode: t }, children: /* @__PURE__ */ d.jsxs(WI, { children: [
    /* @__PURE__ */ d.jsx(PI, {}),
...
function BI(e, t, n = !1) {
  return ve(e) ? HI(t) ? t.test(e) : ve(t) ? n ? e === t : e.includes(t) : !1 : !1;
}
function bn(e, t = [], n = !1) {
  return t.some((r) => BI(e, r, n));
}
function QI(e, t, n = 250, r, o, i, s) {
...
function hs(e, t = {}) {
  ...
  try {
    ...
    const a = " > ", l = a.length;
    let u;
    const g = Array.isArray(t) ? t : t.keyAttrs, M = !Array.isArray(t) && t.maxStringLength || VI;
    for (; n && i++ < r && (u = XI(n, g), !(u === "html" || i > 1 && s + o.length * l + u.length >= M)); )
...
const Lt = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__, qI = "Sentry Logger ", Mr = [
  "debug",
  "info",
  "warn",
  "error",
...
function i2(e) {
  const t = typeof e == "string" ? r2(e) : fs(e);
  if (!(!t || !o2(t)))
    return t;
}
function q(e, t, n) {
...
function _o(e) {
  try {
    return RI(e) ? hs(e) : Object.prototype.toString.call(e);
  } catch {
    return "<unknown>";
  }
}
...
function h2() {
  p2() && q(R, "fetch", function(e) {
    return function(...t) {
      const { method: n, url: r } = f2(t), o = {
        args: t,
        fetchData: {
          method: n,
          url: r
...
const L2 = R, bt = "__sentry_xhr_v3__";
function C2(e) {
  const t = "xhr";
  $e(t, e), qe(t, T2);
}
function T2() {
  if (!L2.XMLHttpRequest)
    return;
  const e = XMLHttpRequest.prototype;
  q(e, "open", function(t) {
    return function(...n) {
      const r = Date.now(), o = ve(n[0]) ? n[0].toUpperCase() : void 0, i = k2(n[1]);
      if (!o || !i)
...
function ws(e, t = 3, n = 100 * 1024) {
  const r = E2(e, t);
  return O2(r) > n ? ws(e, t - 1, n) : r;
}
function fr(e, t, n = 1 / 0, r = 1 / 0, o = z2()) {
  const [i, s] = o;
  if (t == null || // this matches null and undefined -> eqeq not eqeqeq
  ["number", "boolean", "string"].includes(typeof t) && !YI(t))
    return t;
  const a = Z2(e, t);
...
function on(e) {
  return V2(e) ? e.getSpanJSON() : typeof e.toJSON == "function" ? e.toJSON() : {};
}
function V2(e) {
...
function F2(e) {
  if (e)
    return $2(e) ? { captureContext: e } : K2(e) ? {
      captureContext: e
    } : e;
}
function $2(e) {
...
function K2(e) {
  return Object.keys(e).some((t) => q2.includes(t));
}
function Ls(e, t) {
  return Ke().captureException(e, F2(t));
}
function Cs(e, t) {
...
function n5(e) {
  ...
  if (!t)
    return {};
  const n = t5(on(e).trace_id || "", t, e5()), r = ks(e);
  if (!r)
    return n;
  ...
  const a = on(r);
  return s && s !== "url" && (n.transaction = a.description), n.sampled = String(X2(r)), t.emit && t.emit("createDsc", n), n;
}
function r5(e, t) {
  const { fingerprint: n, span: r, breadcrumbs: o, sdkProcessingMetadata: i } = t;
  o5(e, t), r && a5(e, r), c5(e, n), i5(e, o), s5(e, i);
}
function o5(e, t) {
  const {
    extra: n,
...
function a5(e, t) {
  e.contexts = { trace: J2(t), ...e.contexts };
  const n = ks(t);
  if (n) {
    e.sdkProcessingMetadata = {
      dynamicSamplingContext: n5(t),
      ...e.sdkProcessingMetadata
    };
...
function c5(e, t) {
  e.fingerprint = e.fingerprint ? u2(e.fingerprint) : [], t && (e.fingerprint = e.fingerprint.concat(t)), e.fingerprint && !e.fingerprint.length && delete e.fingerprint;
}
const l5 = 100;
class Qe {
...
const u5 = "7.119.2", zs = parseFloat(u5), d5 = 100;
class Es {
  ...
  addBreadcrumb(t, n) {
    ...
    if (!o)
      return;
    const { beforeBreadcrumb: i = null, maxBreadcrumbs: s = d5 } = o.getOptions && o.getOptions() || {};
    if (s <= 0)
      return;
...
`) : W.warn(
  ...
  endSession() {
    ...
    r && Y2(r), this._sendSessionUpdate(), n.setSession();
  }
  /**
   * @inheritDoc
   ...
   */
  startSession(t) {
    const { scope: n, client: r } = this.getStackTop(), { release: o, environment: i = As } = r && r.getOptions() || {}, { userAgent: s } = R.navigator || {}, a = G2({
      release: o,
      environment: i,
      user: n.getUser(),
      ...s && { userAgent: s },
...
function g5(e = Dn()) {
  return (!M5(e) || // eslint-disable-next-line deprecation/deprecation
...
const j5 = [
  ...
  processEvent(t, n, r) {
    const o = r.getOptions(), i = y5(e, o);
    return h5(t, i) ? null : t;
  }
}), Ws = p5;
He(
  Ps,
...
function y5(e = {}, t = {}) {
  return {
    ...
    ignoreTransactions: [
      ...
      ...e.disableTransactionDefaults ? [] : N5
    ],
    ignoreInternal: e.ignoreInternal !== void 0 ? e.ignoreInternal : !0
  };
}
function h5(e, t) {
  return t.ignoreInternal && x5(e) ? (ge && W.warn(`Event dropped due to being internal Sentry Error.
Event: ${ze(e)}`), !0) : f5(e, t.ignoreErrors) ? (ge && W.warn(
    `Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${ze(e)}`
  ), !0) : b5(e, t.ignoreTransactions) ? (ge && W.warn(
    `Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${ze(e)}`
  ), !0) : v5(e, t.denyUrls) ? (ge && W.warn(
    `Event dropped due to being matched by \`denyUrls\` option.
Event: ${ze(
      e
    )}.
Url: ${sn(e)}`
  ), !0) : D5(e, t.allowUrls) ? !1 : (ge && W.warn(
...
function f5(e, t) {
  return e.type || !t || !t.length ? !1 : w5(e).some((n) => bn(n, t));
}
function b5(e, t) {
...
let Xo;
const Os = "FunctionToString", Fo = /* @__PURE__ */ new WeakMap(), A5 = () => ({
  name: Os,
  setupOnce() {
      ...
      values: [
        {
          ...
          value: E5(t, { isUnhandledRejection: r })
        }
      ]
    },
    extra: {
...
function qr(e, t) {
  const n = t.stacktrace || t.stack || "", r = k5(t);
  try {
    return e(n, r);
  } catch {
  }
...
const T5 = /Minified React error #\d+;/i;
function k5(e) {
  if (e) {
    if (typeof e.framesToPop == "number")
      return e.framesToPop;
    if (T5.test(e.message))
      return 1;
  }
  return 0;
}
...
function Hs(e, t, n, r, o) {
  ...
  return Yr(t) ? Fn(e, t) : hn(t) || fn(t) ? (i = C5(e, t, n, o), jr(i, {
    synthetic: !0
...
function E5(e, { isUnhandledRejection: t }) {
  const n = s2(e), r = t ? "promise rejection" : "exception";
  return Br(e) ? `Event \`ErrorEvent\` captured as ${r} with message \`${e.message}\`` : fn(e) ? `Event \`${Z5(e)}\` (type=${e.type}) captured as ${r}` : `Object captured as ${r} with keys: ${n}`;
}
function Z5(e) {
  try {
    const t = Object.getPrototypeOf(e);
...
const Rt = 1024, Gs = "Breadcrumbs", P5 = (e = {}) => {
  const t = {
    console: !0,
    dom: !0,
    fetch: !0,
  ...
  return {
    ...
    // eslint-disable-line @typescript-eslint/no-empty-function
    setup(n) {
      t.console && c2(U5(n)), t.dom && g2(O5(n, t.dom)), t.xhr && C2(_5(n)), t.fetch && y2(R5(n)), t.history && S2(H5(n)), t.sentry && n.on && n.on("beforeSendEvent", W5(n));
    }
  };
}, Ys = P5;
He(Gs, Ys);
...
function O5(e, t) {
  return function(r) {
    ...
    try {
      const u = r.event, g = G5(u) ? u.target : u;
      o = hs(g, { keyAttrs: s, maxStringLength: a }), i = $I(g);
    } catch {
      o = "<unknown>";
    }
    if (o.length === 0)
...
const Xs = "GlobalHandlers", V5 = (e = {}) => {
  ...
  return {
    ...
    setup(n) {
      t.onerror && (X5(n), ei("onerror")), t.onunhandledrejection && (F5(n), ei("onunhandledrejection"));
    }
  };
}, Fs = V5;
He(
...
function X5(e) {
  b2((t) => {
    ...
    if (ae() !== e || _s())
      return;
    const { msg: o, url: i, line: s, column: a, error: l } = t, u = l === void 0 && ve(o) ? K5(o, i, s, a) : $s(
      Hs(n, l || o, void 0, r, !1),
      i,
      s,
      a
...
function F5(e) {
  D2((t) => {
    ...
    if (ae() !== e || _s())
      return;
    const o = $5(t), i = Ns(o) ? q5(o) : Hs(n, o, void 0, r, !0);
    i.level = "error", Cs(i, {
      originalException: o,
      mechanism: {
        handled: !1,
...
function $s(e, t, n, r) {
  const o = e.exception = e.exception || {}, i = o.values = o.values || [], s = i[0] = i[0] || {}, a = s.stacktrace = s.stacktrace || {}, l = a.frames = a.frames || [], u = isNaN(parseInt(r, 10)) ? void 0 : r, g = isNaN(parseInt(n, 10)) ? void 0 : n, M = ve(t) && t.length > 0 ? t : FI();
...
He(Ks, ea);
const tm = "cause", nm = 5, ta = "LinkedErrors", rm = (e = {}) => {
  const t = e.limit || nm, n = e.key || tm;
  return {
    name: ta,
    // TODO v8: Remove this
    setupOnce() {
...
const om = [
  ...
  return {
    ...
    setupOnce() {
      t.setTimeout && q(X, "setTimeout", ti), t.setInterval && q(X, "setInterval", ti), t.requestAnimationFrame && q(X, "requestAnimationFrame", sm), t.XMLHttpRequest && "XMLHttpRequest" in X && q(XMLHttpRequest.prototype, "send", am);
      const n = t.eventTarget;
      n && (Array.isArray(n) ? n : om).forEach(cm);
    }
  };
}, oa = im;
He(
...
const ni = (e = {}, t = Ke()) => {
  ...
  i.async = !0, i.crossOrigin = "anonymous", i.src = m5(o, e), e.onLoad && (i.onload = e.onLoad);
  const { onClose: s } = e;
  if (s) {
    const l = (u) => {
...
O.isValidElementType = function(e) {
  return typeof e == "string" || typeof e == "function" || e === wn || e === Cn || e === Sn || e === xn || e === kn || e === lm || typeof e == "object" && e !== null && (e.$$typeof === En || e.$$typeof === zn || e.$$typeof === An || e.$$typeof === Ln || e.$$typeof === Tn || e.$$typeof === dm || e.$$typeof === gm || e.$$typeof === Mm || e.$$typeof === um);
};
O.typeOf = ce;
ia.exports = O;
var Im = ia.exports, aa = Im, mm = {
  $$typeof: !0,
  render: !0,
  defaultProps: !0,
  displayName: !0,
...
ca[aa.ForwardRef] = mm;
ca[aa.Memo] = jm;
const Nm = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__;
function pm(e) {
  const t = e.match(/^([^.]+)/);
  ...
  componentDidCatch(t, { componentStack: n }) {
    ...
    Ts((a) => {
      if (pm(Yi) && Yr(t)) {
        ...
        u.name = `React ErrorBoundary ${t.name}`, u.stack = n, ym(t, u);
      }
      r && r(a, t, n);
      const l = Ls(t, {
        captureContext: {
  ...
  render() {
    ...
    if (r.error) {
      ...
      return typeof t == "function" ? o = t({
        ...
        eventId: r.eventId
      }) : o = t, ut(o) ? o : (t && Nm && W.warn("fallback did not produce a valid ReactElement"), null);
    }
    return typeof n == "function" ? n() : n;
  }
}
const hm = ["top", "right", "bottom", "left"], We = Math.min, oe = Math.max, an = Math.round, Ht = Math.floor, Oe = (e) => ({
  x: e,
  y: e
}), fm = {
  left: "right",
...
async function wt(e, t) {
  ...
  const {
    ...
    altBoundary: m = !1,
    padding: I = 0
  } = we(t, e), j = la(I), p = a[m ? M === "floating" ? "reference" : "floating" : M], y = ln(await i.getClippingRect({
  ...
  return {
    top: (y.top - v.top + j.top) / b.y,
    bottom: (v.bottom - y.bottom + j.bottom) / b.y,
    left: (y.left - v.left + j.left) / b.x,
    right: (v.right - y.right + j.right) / b.x
  };
}
const ii = (e) => ({
  name: "arrow",
  ...
  async fn(t) {
    ...
    const g = la(u), M = {
      x: n,
      y: r
    }, m = io(o), I = oo(m), j = await s.getDimensions(l), N = m === "y", p = N ? "top" : "left", y = N ? "bottom" : "right", h = N ? "clientHeight" : "clientWidth", f = i.reference[I] + i.reference[m] - M[m] - i.floating[I], b = M[m] - i.reference[m], v = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(l));
    let D = v ? v[h] : 0;
    (!D || !await (s.isElement == null ? void 0 : s.isElement(v))) && (D = a.floating[h] || i.floating[I]);
    const w = f / 2 - b / 2, x = D / 2 - j[I] / 2 - 1, k = We(g[p], x), U = We(g[y], x), S = k, Y = D - j[I] - U, _ = D / 2 - j[I] / 2 + w, G = wr(S, _, Y), z = pt(o) != null && _ != G && i.reference[I] / 2 - (_ < S ? k : U) - j[I] / 2 < 0 ? _ < S ? S - _ : Y - _ : 0;
    return {
      [m]: M[m] - z,
      data: {
        [m]: G,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const {
        ...
        flipAlignment: j = !0,
        ...N
      } = we(e, t), p = xe(r), y = xe(s) === s, h = await (a.isRTL == null ? void 0 : a.isRTL(l.floating)), f = M || (y || !j ? [cn(s)] : Dm(s));
      !M && I !== "none" && f.push(...xm(s, j, I, h));
...
const km = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      let I = u[m], j = u[M];
      if (i) {
        const p = m === "y" ? "top" : "left", y = m === "y" ? "bottom" : "right", h = I + g[p], f = I - g[y];
        I = wr(h, I, f);
      }
      if (s) {
        const p = M === "y" ? "top" : "left", y = M === "y" ? "bottom" : "right", h = j + g[p], f = j - g[y];
        j = wr(h, j, f);
      }
      const N = a.fn({
        ...t,
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (u) {
        var y, h;
        const f = m === "y" ? "width" : "height", b = ["top", "left"].includes(xe(o)), v = i.reference[M] - i.floating[f] + (b && ((y = s.offset) == null ? void 0 : y[M]) || 0) + (b ? 0 : p.crossAxis), D = i.reference[M] + i.reference[f] + (b ? 0 : ((h = s.offset) == null ? void 0 : h[M]) || 0) - (b ? p.crossAxis : 0);
        j < v ? j = v : j > D && (j = D);
      }
      return {
        [m]: I,
...
function ga(e) {
  ...
  const o = ye(e), i = o ? e.offsetWidth : n, s = o ? e.offsetHeight : r, a = an(n) !== i || an(r) !== s;
  return a && (n = i, r = s), {
    width: n,
    height: r,
    $: a
...
const Om = /* @__PURE__ */ Oe(0);
function Ma(e) {
  const t = se(e);
  return !ao() || !t.visualViewport ? Om : {
...
function Xe(e, t, n, r) {
  ...
  const a = Um(i, n, r) ? Ma(i) : Oe(0);
  let l = (o.left + a.x) / s.x, u = (o.top + a.y) / s.y, g = o.width / s.x, M = o.height / s.y;
  if (i) {
    const m = se(i), I = r && Se(r) ? se(r) : r;
    let j = m.frameElement;
    for (; j && r && I !== m; ) {
      const N = ct(j), p = j.getBoundingClientRect(), y = ue(j), h = p.left + (j.clientLeft + parseFloat(y.paddingLeft)) * N.x, f = p.top + (j.clientTop + parseFloat(y.paddingTop)) * N.y;
      l *= N.x, u *= N.y, g *= N.x, M *= N.y, l += h, u += f, j = se(j).frameElement;
    }
  }
  return ln({
    width: g,
...
function _m(e) {
  ...
  const l = Oe(0);
  if ((o || !o && r !== "fixed") && ((Ue(n) !== "body" || Ct(i)) && (s = Pn(n)), ye(n))) {
    const u = Xe(n);
...
function Ym(e, t) {
  const n = Xe(e, !0, t === "fixed"), r = n.top + e.clientTop, o = n.left + e.clientLeft, i = ye(e) ? ct(e) : Oe(1), s = e.clientWidth * i.x, a = e.clientHeight * i.y, l = o * i.x, u = r * i.y;
  return {
    width: s,
    height: a,
    x: l,
...
function Qm(e) {
  ...
  const s = [...n === "clippingAncestors" ? Bm(t, this._c) : [].concat(n), r], a = s[0], l = s.reduce((u, g) => {
    const M = li(t, g, o);
...
function ja(e, t) {
  ...
  if (!ye(e))
    return n;
  let r = ui(e, t);
  for (; r && Pm(r) && ue(r).position === "static"; )
    r = ui(r, t);
  return r && (Ue(r) === "html" || Ue(r) === "body" && ue(r).position === "static" && !so(r)) ? n : r || Wm(e) || n;
}
...
var lo = "Switch", [rj, Sy] = _e(lo), [oj, ij] = rj(lo), Na = E(
  (e, t) => {
    const {
      __scopeSwitch: n,
      name: r,
    ...
    return /* @__PURE__ */ d.jsxs(oj, { scope: n, checked: p, disabled: a, children: [
      /* @__PURE__ */ d.jsx(
        Q.button,
        {
          type: "button",
          ...
          onClick: H(e.onClick, (h) => {
            y((f) => !f), N && (j.current = h.isPropagationStopped(), j.current || h.stopPropagation());
          })
        }
      ),
      N && /* @__PURE__ */ d.jsx(
...
var pa = "SwitchThumb", ya = E(
  (e, t) => {
    const { __scopeSwitch: n, ...r } = e, o = ij(pa, n);
    return /* @__PURE__ */ d.jsx(
      Q.span,
      {
  ...
  return /* @__PURE__ */ d.jsxs("div", { children: [
    /* @__PURE__ */ d.jsxs("div", { className: `group flex items-start gap-2 dark:text-white ${t === "rtl" && "justify-between"} ${a && "pb-2"}`, children: [
      /* @__PURE__ */ d.jsx(aj, { className: A(
        ...
        j,
        t === "rtl" && " order-2"
      ), defaultChecked: u, disabled: g, id: I, name: M, onCheckedChange: h, children: /* @__PURE__ */ d.jsx(cj, { className: A(
        N,
...
}, lj = ({ size: e = "md", buttons: t, link: n, linkWithPadding: r, clearBg: o = !0, outlineOnMobile: i, className: s }) => {
  let a = A(
...
function dj(e) {
  ...
  const a = e + "CollectionSlot", l = P.forwardRef(
    (I, j) => {
      const { scope: N, children: p } = I, y = i(a, N), h = te(j, y.collectionRef);
  ...
  const u = e + "CollectionItemSlot", g = "data-radix-collection-item", M = P.forwardRef(
    (I, j) => {
      const { scope: N, children: p, ...y } = I, h = P.useRef(null), f = te(j, h), b = i(u, N);
      return P.useEffect(() => (b.itemMap.set(h, { ref: h, ...y }), () => void b.itemMap.delete(h))), /* @__PURE__ */ d.jsx(vt, { [g]: "", ref: f, children: p });
    }
  );
  M.displayName = u;
  function m(I) {
    ...
    return P.useCallback(() => {
      ...
      return Array.from(j.itemMap.values()).sort(
        (b, v) => y.indexOf(b.ref.current) - y.indexOf(v.ref.current)
      );
...
var qn = "rovingFocusGroup.onEntryFocus", Ij = { bubbles: !1, cancelable: !0 }, On = "RovingFocusGroup", [Sr, ba, mj] = dj(On), [jj, va] = _e(
  On,
  [mj]
), [Nj, pj] = jj(On), Da = E(
  (e, t) => /* @__PURE__ */ d.jsx(Sr.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ d.jsx(Sr.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ d.jsx(yj, { ...e, ref: t }) }) })
);
Da.displayName = On;
var yj = E((e, t) => {
  const {
    ...
    defaultProp: a,
    onChange: l
  }), [y, h] = Z(!1), f = gj(u), b = ba(n), v = C(!1), [D, w] = Z(0);
  return L(() => {
    const x = m.current;
    if (x)
  ...
  (e, t) => {
    const {
      ...
      tabStopId: i,
      ...s
    } = e, a = Wn(), l = i || a, u = pj(wa, n), g = u.currentTabStopId === l, M = ba(n), { onFocusableItemAdd: m, onFocusableItemRemove: I } = u;
    return L(() => {
      if (r)
        return m(), () => I();
          ...
          Q.span,
          {
            ...
            onKeyDown: H(e.onKeyDown, (j) => {
              ...
              if (j.target !== j.currentTarget)
                return;
              const N = bj(j, u.orientation, u.dir);
              if (N !== void 0) {
...
var Dj = Da, wj = xa, uo = "Tabs", [xj, Ay] = _e(uo, [
  va
]), Aa = va(), [Sj, go] = xj(uo), Aj = E(
  (e, t) => {
    const {
      __scopeTabs: n,
      value: r,
...
const kj = ({
  ...
  return /* @__PURE__ */ d.jsx(Cj, { children: /* @__PURE__ */ d.jsxs("div", { className: s, role: "tablist", children: [
...
var Mo = "Avatar", [Ej, Ly] = _e(Mo), [Zj, Wa] = Ej(Mo), Oa = E(
  (e, t) => {
...
const Ar = ({ image: e, label: t, labelColor: n, bgColor: r, size: o, className: i }) => {
  ...
  return /* @__PURE__ */ d.jsxs(Wj, { className: `relative inline-flex select-none items-center justify-center overflow-hidden rounded-full align-middle ${s}`, children: [
    e ? /* @__PURE__ */ d.jsx(Oj, { className: `absolute z-20 h-full w-full object-cover ${i && i}`, src: e }) : /* @__PURE__ */ d.jsx("span", { className: `${n && `text-${n}`} relative z-10 inline-flex h-full w-full items-center justify-center p-2 font-semibold ${i && i}`, style: r ? { backgroundColor: r } : {}, children: t }),
    /* @__PURE__ */ d.jsx(Uj, { asChild: !0, children: /* @__PURE__ */ d.jsx(ns, { className: `${a} absolute z-0 h-full w-full text-grey-300` }) })
  ] });
};
function Ga(e) {
  const t = C(e);
...
var Hj = "DismissableLayer", Lr = "dismissableLayer.update", Gj = "dismissableLayer.pointerDownOutside", Yj = "dismissableLayer.focusOutside", di, Ya = Ne({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...l
    } = e, u = le(Ya), [g, M] = Z(null), m = (g == null ? void 0 : g.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, I] = Z({}), j = te(t, (w) => M(w)), N = Array.from(u.layers), [p] = [...u.layersWithOutsidePointerEventsDisabled].slice(-1), y = N.indexOf(p), h = g ? N.indexOf(g) : -1, f = u.layersWithOutsidePointerEventsDisabled.size > 0, b = h >= y, v = Jj((w) => {
    ...
    return Rj((w) => {
      h === u.layers.size - 1 && (r == null || r(w), !w.defaultPrevented && a && (w.preventDefault(), a()));
    }, m), L(() => {
      if (g)
...
Io.displayName = Hj;
var Bj = "DismissableLayerBranch", Qj = E((e, t) => {
...
Qj.displayName = Bj;
function Jj(e, t = globalThis == null ? void 0 : globalThis.document) {
...
function Vj(e, t = globalThis == null ? void 0 : globalThis.document) {
  const n = Ga(e), r = C(!1);
  return L(() => {
    const o = (i) => {
      i.target && !r.current && Ba(Yj, n, { originalEvent: i }, {
        discrete: !1
      });
    };
...
var er = "focusScope.autoFocusOnMount", tr = "focusScope.autoFocusOnUnmount", mi = { bubbles: !1, cancelable: !0 }, Fj = "FocusScope", Qa = E((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  L(() => {
    ...
    if (a) {
      ...
      if (!a.contains(N)) {
        ...
        a.addEventListener(er, u), a.dispatchEvent(y), y.defaultPrevented || ($j(nN(Ja(a)), { select: !0 }), document.activeElement === N && Le(a));
      }
      return () => {
  ...
  const j = T(
    (N) => {
      ...
      if (p && y) {
        const h = N.currentTarget, [f, b] = qj(h);
        f && b ? !N.shiftKey && y === b ? (N.preventDefault(), n && Le(f, { select: !0 })) : N.shiftKey && y === f && (N.preventDefault(), n && Le(b, { select: !0 })) : y === h && N.preventDefault();
      }
    },
    [n, r, I.paused]
  );
...
function Le(e, { select: t = !1 } = {}) {
  if (e && e.focus) {
    const n = document.activeElement;
    e.focus({ preventScroll: !0 }), e !== n && eN(e) && t && e.select();
  }
}
var Ni = tN();
function tN() {
...
function oN(e) {
  ...
  const [j, N] = Z(null), [p, y] = Z(null), h = T((z) => {
  ...
  }, [y]), b = i || j, v = s || p, D = C(null), w = C(null), x = C(g), k = hi(l), U = hi(o), S = T(() => {
    ...
    U.current && (z.platform = U.current), ej(D.current, w.current, z).then((ne) => {
      const re = {
        ...ne,
        isPositioned: !0
      };
...
var mo = "Popper", [Fa, Un] = _e(mo), [cN, $a] = Fa(mo), qa = (e) => {
  const { __scopePopper: t, children: n } = e, [r, o] = Z(null);
  return /* @__PURE__ */ d.jsx(cN, { scope: t, anchor: r, onAnchorChange: o, children: n });
};
qa.displayName = mo;
...
ec.displayName = Ka;
var jo = "PopperContent", [lN, uN] = Fa(jo), tc = E(
  (e, t) => {
    ...
    const {
      ...
      onPlaced: j,
      ...N
    } = e, p = $a(jo, n), [y, h] = Z(null), f = te(t, (ht) => h(ht)), [b, v] = Z(null), D = Xi(b), w = (D == null ? void 0 : D.width) ?? 0, x = (D == null ? void 0 : D.height) ?? 0, k = r + (i !== "center" ? "-" + i : ""), U = typeof g == "number" ? g : { top: 0, right: 0, bottom: 0, left: 0, ...g }, S = Array.isArray(u) ? u : [u], Y = S.length > 0, _ = {
      padding: U,
      boundary: S.filter(gN),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: Y
    }, { refs: G, floatingStyles: $, placement: z, isPositioned: ne, middlewareData: re } = oN({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: k,
      whileElementsMounted: (...ht) => Km(...ht, {
      ...
      middleware: [
        km({ mainAxis: o + x, alignmentAxis: s }),
        l && zm({
          mainAxis: !0,
          crossAxis: !1,
        ...
        b && rN({ element: b, padding: a }),
        MN({ arrowWidth: w, arrowHeight: x }),
        m && Cm({ strategy: "referenceHidden", ..._ })
      ]
    }), [wo, Xc] = oc(z), kt = aN(j);
    Ze(() => {
      ne && (kt == null || kt());
...
tc.displayName = jo;
var nc = "PopperArrow", dN = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, rc = E(function(t, n) {
  const { __scopePopper: r, ...o } = t, i = uN(nc, r), s = dN[i.placedSide];
  return (
...
var MN = (e) => ({
  ...
  fn(t) {
    var p, y, h;
    const { placement: n, rects: r, middlewareData: o } = t, s = ((p = o.arrow) == null ? void 0 : p.centerOffset) !== 0, a = s ? 0 : e.arrowWidth, l = s ? 0 : e.arrowHeight, [u, g] = oc(n), M = { start: "0%", center: "50%", end: "100%" }[g], m = (((y = o.arrow) == null ? void 0 : y.x) ?? 0) + a / 2, I = (((h = o.arrow) == null ? void 0 : h.y) ?? 0) + l / 2;
    let j = "", N = "";
...
var ic = qa, No = ec, sc = tc, ac = rc, IN = function(e) {
  ...
  return o ? (r.push.apply(r, Array.from(o.querySelectorAll("[aria-live]"))), jN(r, o, n, "aria-hidden")) : function() {
    return null;
  };
}, pe = function() {
...
var Kt = "right-scroll-bar-position", en = "width-before-scroll-bar", yN = "with-scroll-bars-hidden", hN = "--removed-body-scroll-bar-size";
function fN(e, t) {
...
var dc = xN(), rr = function() {
}, _n = E(function(e, t) {
  var n = C(null), r = Z({
    onScrollCapture: rr,
    onWheelCapture: rr,
    onTouchMoveCapture: rr
  }), o = r[0], i = r[1], s = e.forwardProps, a = e.children, l = e.className, u = e.removeScrollBar, g = e.enabled, M = e.shards, m = e.sideCar, I = e.noIsolation, j = e.inert, N = e.allowPinchZoom, p = e.as, y = p === void 0 ? "div" : p, h = e.gapMode, f = lc(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), b = m, v = vN([n, t]), D = pe(pe({}, f), o);
  return c(
    mn,
    null,
    g && c(b, { sideCar: dc, removeScrollBar: u, shards: M, noIsolation: I, inert: j, setCallbacks: i, allowPinchZoom: !!N, lockRef: n, gapMode: h }),
...
}, WN = gc(), lt = "data-scroll-locked", ON = function(e, t, n, r) {
...
`);
  ...
  return c(WN, { styles: ON(i, !t, o, n ? "" : "!important") });
}, Cr = !1;
if (typeof window < "u")
  try {
...
var nt = Cr ? { passive: !1 } : !1, RN = function(e) {
  ...
  var i = QN(e, window.getComputedStyle(t).direction), s = i * r, a = n.target, l = t.contains(a), u = !1, g = s > 0, M = 0, m = 0;
  do {
    var I = mc(e, a), j = I[0], N = I[1], p = I[2], y = N - p - i * j;
    (j || y) && Ic(e, a) && (M += y, m += j), a instanceof ShadowRoot ? a = a.host : a = a.parentNode;
  } while (
    // portaled content
...
function $N(e) {
  var t = C([]), n = C([0, 0]), r = C(), o = Z(FN++)[0], i = Z(gc)[0], s = C(e);
  L(function() {
    s.current = e;
  }, [e]), L(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var N = pN([e.lockRef.current], (e.shards || []).map(wi), !0).filter(Boolean);
  ...
  var a = T(function(N, p) {
    ...
    var y = Qt(N), h = n.current, f = "deltaX" in N ? N.deltaX : h[0] - y[0], b = "deltaY" in N ? N.deltaY : h[1] - y[1], v, D = N.target, w = Math.abs(f) > Math.abs(b) ? "h" : "v";
    ...
    if (!r.current && "changedTouches" in N && (f || b) && (r.current = v), !v)
      return !0;
    var k = r.current || v;
    return JN(k, p, N, k === "h" ? f : b, !0);
  }, []), l = T(function(N) {
    var p = N;
    if (!(!rt.length || rt[rt.length - 1] !== i)) {
      var y = "deltaY" in p ? Di(p) : Qt(p), h = t.current.filter(function(v) {
        return v.name === p.type && (v.target === p.target || p.target === v.shadowParent) && VN(v.delta, y);
      })[0];
      if (h && h.should) {
    ...
    var f = { name: N, delta: p, target: y, should: h, shadowParent: qN(y) };
  ...
  return c(
    mn,
    null,
    j ? c(i, { styles: XN(o) }) : null,
    I ? c(_N, { gapMode: e.gapMode }) : null
  );
}
function qN(e) {
...
var jc = E(function(e, t) {
  return c(_n, pe({}, e, { ref: t, sideCar: KN }));
});
jc.classNames = _n.classNames;
const ep = jc;
var po = "Popover", [Nc, Cy] = _e(po, [
  Un
]), Tt = Un(), [tp, et] = Nc(po), pc = (e) => {
  const {
    __scopePopover: t,
    children: n,
    open: r,
...
var yc = "PopoverAnchor", hc = E(
  (e, t) => {
    const { __scopePopover: n, ...r } = e, o = et(yc, n), i = Tt(n), { onCustomAnchorAdd: s, onCustomAnchorRemove: a } = o;
...
bc.displayName = fc;
var np = "PopoverPortal", [Ty, rp] = Nc(np, {
  forceMount: void 0
}), Mt = "PopoverContent", vc = E(
  (e, t) => {
    const n = rp(Mt, e.__scopePopover), { forceMount: r = n.forceMount, ...o } = e, i = et(Mt, e.__scopePopover);
    return /* @__PURE__ */ d.jsx(jn, { present: r || i.open, children: i.modal ? /* @__PURE__ */ d.jsx(op, { ...o, ref: t }) : /* @__PURE__ */ d.jsx(ip, { ...o, ref: t }) });
  }
);
vc.displayName = Mt;
var op = E(
  (e, t) => {
    ...
    return L(() => {
      ...
      if (s)
        return NN(s);
    }, []), /* @__PURE__ */ d.jsx(ep, { as: vt, allowPinchZoom: !0, children: /* @__PURE__ */ d.jsx(
      Dc,
      {
        ...e,
        ref: o,
...
const Mp = ({
  ...
  return /* @__PURE__ */ d.jsxs(lp, { open: o, onOpenChange: i, children: [
    /* @__PURE__ */ d.jsx(up, { asChild: !0, children: /* @__PURE__ */ d.jsx(dp, { asChild: !0, children: e }) }),
    /* @__PURE__ */ d.jsx(gp, { align: n, className: "z-50 mt-2 origin-top-right rounded bg-white shadow-md ring-1 ring-[rgba(0,0,0,0.01)] focus:outline-none dark:bg-grey-900 dark:text-white", "data-testid": "popover-content", side: "bottom", onClick: s, children: t })
  ] });
};
function Ip(e) {
...
function jp(e) {
  var t, n;
  return e ? Ip(e) ? e : mp(e) && (t = (n = e.ownerDocument) == null ? void 0 : n.defaultView) != null ? t : window : window;
}
var xi;
(function(e) {
  e.DragStart = "dragStart", e.DragMove = "dragMove", e.DragEnd = "dragEnd", e.DragCancel = "dragCancel", e.DragOver = "dragOver", e.RegisterDroppable = "registerDroppable", e.SetDroppableDisabled = "setDroppableDisabled", e.UnregisterDroppable = "unregisterDroppable";
})(xi || (xi = {}));
const Np = /* @__PURE__ */ Object.freeze({
  x: 0,
  y: 0
});
function pp(e) {
...
Lc.displayName = fp;
var bp = Lc, [Rn, ky] = _e("Tooltip", [
  Un
]), Hn = Un(), Cc = "TooltipProvider", vp = 700, zr = "tooltip.open", [Dp, yo] = Rn(Cc), Tc = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = vp,
...
Tc.displayName = Cc;
var Gn = "Tooltip", [wp, Yn] = Rn(Gn), kc = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
    ...
    delayDuration: a
  } = e, l = yo(Gn, e.__scopeTooltip), u = Hn(t), [g, M] = Z(null), m = Wn(), I = C(0), j = s ?? l.disableHoverableContent, N = a ?? l.delayDuration, p = C(!1), [y = !1, h] = St({
    prop: r,
    defaultProp: o,
    onChange: (w) => {
      w ? (l.onOpen(), document.dispatchEvent(new CustomEvent(zr))) : l.onClose(), i == null || i(w);
    }
  }), f = J(() => y ? p.current ? "delayed-open" : "instant-open" : "closed", [y]), b = T(() => {
...
zc.displayName = Er;
var xp = "TooltipPortal", [zy, Sp] = Rn(xp, {
  forceMount: void 0
}), It = "TooltipContent", Ec = E(
  (e, t) => {
    const n = Sp(It, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...i } = e, s = Yn(It, e.__scopeTooltip);
    return /* @__PURE__ */ d.jsx(jn, { present: r || s.open, children: s.disableHoverableContent ? /* @__PURE__ */ d.jsx(Zc, { side: o, ...i, ref: t }) : /* @__PURE__ */ d.jsx(Ap, { side: o, ...i, ref: t }) });
  }
), Ap = E((e, t) => {
  const n = Yn(It, e.__scopeTooltip), r = yo(It, e.__scopeTooltip), o = C(null), i = te(t, o), [s, a] = Z(null), { trigger: l, onClose: u } = n, g = o.current, { onPointerInTransitChange: M } = r, m = T(() => {
    ...
    (j, N) => {
      const p = j.currentTarget, y = { x: j.clientX, y: j.clientY }, h = kp(y, p.getBoundingClientRect()), f = zp(y, h), b = Ep(N.getBoundingClientRect()), v = Pp([...f, ...b]);
      a(v), M(!0);
    },
    [M]
  );
  return L(() => () => m(), [m]), L(() => {
    ...
    if (s) {
      const j = (N) => {
        const p = N.target, y = { x: N.clientX, y: N.clientY }, h = (l == null ? void 0 : l.contains(p)) || (g == null ? void 0 : g.contains(p)), f = !Zp(y, s);
        h ? m() : f && (m(), u());
      };
        ...
        children: /* @__PURE__ */ d.jsxs(
          sc,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ d.jsx(Lp, { scope: n, isInside: !0, children: /* @__PURE__ */ d.jsx(bp, { id: l.contentId, role: "tooltip", children: o || r }) })
            ]
          }
        )
      }
...
const Hp = ({
  ...
  return o || (o = /* @__PURE__ */ d.jsx(ie, { className: "flex-row-reverse", icon: `${g === "asc" ? "arrow-up" : "arrow-down"}`, iconColorClass: "!w-3 !h-3 !mr-0 ml-1.5", label: `${(a = l.find((j) => j.selected)) == null ? void 0 : a.label}`, ...i })), /* @__PURE__ */ d.jsx(Mp, { position: s, trigger: o, children: /* @__PURE__ */ d.jsxs("div", { className: "flex flex-col", children: [
...
}, Bp = ({ content: e, size: t = "sm", children: n, containerClassName: r, tooltipClassName: o, origin: i = "center" }) => (r = A(
  "will-change-[opacity]",
  r
), o = A(
  ...
  t === "sm" && "text-xs",
  t === "md" && "text-sm"
), /* @__PURE__ */ d.jsx(Op, { delayDuration: 0, children: /* @__PURE__ */ d.jsxs(Up, { children: [
  /* @__PURE__ */ d.jsx(_p, { className: r, onClick: (s) => s.preventDefault(), children: n }),
  /* @__PURE__ */ d.jsx(Rp, { align: i, className: o, sideOffset: 4, onPointerDownOutside: (s) => s.preventDefault(), children: e })
] }) })), Qp = ({
  left: e,
  center: t,
  right: n,
...
}, Jp = () => /* @__PURE__ */ d.jsx(ie, { icon: "hamburger", iconColorClass: "text-black dark:text-white", size: "sm", link: !0, onClick: () => {
  alert("Clicked on hamburger");
} }), Vp = () => /* @__PURE__ */ d.jsx(ie, { icon: "magnifying-glass", iconColorClass: "dark:text-white text-black", size: "sm", link: !0, onClick: () => {
} }), Wc = ({
  fullBleedPage: e = !0,
...
}, Xp = ({ darkMode: e, fetchKoenigLexical: t, className: n, children: r, ...o }) => {
  const i = A(
    "admin-x-base",
    e && "dark",
    n
  );
  return /* @__PURE__ */ d.jsx("div", { className: i, ...o, children: /* @__PURE__ */ d.jsx(UI, { darkMode: e, fetchKoenigLexical: t, children: r }) });
};
class Bn {
  constructor() {
...
const Pr = new ty(), Oi = ["online", "offline"];
class ny extends Bn {
  constructor() {
    super(), this.setup = (t) => {
      if (!ho && window.addEventListener) {
...
function Yc(e) {
  ...
  const a = new Promise((p, y) => {
    ...
    Promise.resolve(p).then(m).catch((y) => {
      ...
      if (r)
        return;
      const b = (h = e.retry) != null ? h : 3, v = (f = e.retryDelay) != null ? f : ry, D = typeof v == "function" ? v(n, y) : v, w = b === !0 || typeof b == "number" && n < b || typeof b == "function" && b(n, y);
      if (t || !w) {
        I(y);
        return;
      }
...
class Bc {
  ...
  scheduleGc() {
    this.clearGcTimeout(), $p(this.cacheTime) && (this.gcTimeout = setTimeout(() => {
      this.optionalRemove();
    }, this.cacheTime));
  }
  updateCacheTime(t) {
...
class iy extends Bc {
  constructor(t) {
    super(), this.abortSignalConsumed = !1, this.defaultOptions = t.defaultOptions, this.setOptions(t.options), this.observers = [], this.cache = t.cache, this.logger = t.logger || vo, this.queryKey = t.queryKey, this.queryHash = t.queryHash, this.initialState = t.state || sy(this.options), this.state = this.initialState, this.scheduleGc();
  }
  get meta() {
  ...
  setData(t, n) {
    const r = ey(this.state.data, t, this.options);
  ...
  isStaleByTime(t = 0) {
    return this.state.isInvalidated || !this.state.dataUpdatedAt || !qp(this.state.dataUpdatedAt, t);
  }
  onFocus() {
    var t;
...
class cy extends Bc {
  constructor(t) {
    super(), this.defaultOptions = t.defaultOptions, this.mutationId = t.mutationId, this.mutationCache = t.mutationCache, this.logger = t.logger || vo, this.observers = [], this.state = t.state || ly(), this.setOptions(t.options), this.scheduleGc();
  }
  setOptions(t) {
    this.options = {
      ...this.defaultOptions,
  ...
  return {
    onFetch: (e) => {
      e.fetchFn = () => {
        ...
        }, y = e.options.queryFn || (() => Promise.reject("Missing queryFn for queryKey '" + e.options.queryHash + "'")), h = (D, w, x, k) => (j = k ? [w, ...j] : [...j, w], k ? [x, ...D] : [...D, x]), f = (D, w, x, k) => {
          if (N)
        ...
        if (!m.length)
          ...
          const D = typeof u < "u", w = D ? u : gy(e.options, m);
          b = f(m, D, w, !0);
        } else {
          j = [];
          const D = typeof e.options.getNextPageParam > "u";
          b = (a && m[0] ? a(m[0], 0, m) : !0) ? f([], D, I[0]) : Promise.resolve(h([], I[0], m[0]));
...
class My {
  constructor(t = {}) {
    this.queryCache = t.queryCache || new ay(), this.mutationCache = t.mutationCache || new uy(), this.logger = t.logger || vo, this.defaultOptions = t.defaultOptions || {}, this.queryDefaults = [], this.mutationDefaults = [], this.mountCount = 0;
  }
  mount() {
  ...
  setQueryData(t, n, r) {
    const o = this.queryCache.find(t), i = o == null ? void 0 : o.state.data, s = Fp(n, i);
    if (typeof s > "u")
      return;
...
const _i = /* @__PURE__ */ Ne(void 0), Iy = /* @__PURE__ */ Ne(!1);
function my(e, t) {
...
}, Qc = window.adminXQueryClient || new My({
  defaultOptions: {
    queries: {
...
function Ny({ children: e, ...t }) {
  return /* @__PURE__ */ d.jsx(no, { children: /* @__PURE__ */ d.jsx(jy, { client: Qc, children: /* @__PURE__ */ d.jsx(Jc.Provider, { value: t, children: e }) }) });
}
const py = () => le(Jc), Vc = Ne({
  route: "",
  updateRoute: () => {
  },
  loadingModal: !1,
...
const hy = (e, t, n, r) => {
  ...
  o = o.substring(1);
  const i = `${window.location.protocol}//${window.location.hostname}`, s = new URL(o, i), a = yy(e, s.pathname), l = s.searchParams;
  if (a && r && n) {
  ...
  if (r)
    return r.groups || {};
}, fy = ({ basePath: e, modals: t, children: n }) => {
  const { externalNavigate: r } = py(), [o, i] = Z(void 0), [s, a] = Z(!1), [l] = Z(new EventTarget()), u = T((g) => {
  ...
  return L(() => {
    ...
    const g = () => {
      i((M) => {
        const { pathName: m, modal: I, changingModal: j } = hy(e, M, t == null ? void 0 : t.load, t == null ? void 0 : t.paths);
...
const by = () => {
  ...
  const { updateRoute: e } = Do(), [t, n] = Z("list"), r = [
    /* @__PURE__ */ d.jsx(ie, { label: "Filter", onClick: () => {
      Yp({ message: "Were you really expecting a filter? 😛" });
    } }),
    /* @__PURE__ */ d.jsx(
      Hp,
      {
    ...
    /* @__PURE__ */ d.jsx(Bp, { content: "Search members", children: /* @__PURE__ */ d.jsx(ie, { icon: "magnifying-glass", size: "sm", onClick: () => {
      alert("Clicked search");
    } }) }),
    /* @__PURE__ */ d.jsx(lj, { buttons: [
      {
        icon: "listview",
        size: "sm",
  ...
  const { route: e } = Do();
  return e === "detail" ? /* @__PURE__ */ d.jsx(by, {}) : /* @__PURE__ */ d.jsx(vy, {});
}, wy = {
  paths: {
    "demo-modal": "DemoModal"
  },
  load: async () => import("./modals-1dd517c9.mjs")
}, Ey = ({ framework: e, designSystem: t }) => /* @__PURE__ */ d.jsx(Ny, { ...e, children: /* @__PURE__ */ d.jsx(fy, { basePath: "demo-x", modals: wy, children: /* @__PURE__ */ d.jsx(Xp, { className: "admin-x-demo", ...t, children: /* @__PURE__ */ d.jsx(Dy, {}) }) }) });
export {
  Ey as A,
  ie as B,
  B as H,
...
//# sourceMappingURL=index-4e95bd22.mjs.map
